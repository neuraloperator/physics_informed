...
from baselines.model import DeepONet
from baselines.data import DeepOnetNS
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logfile', type=str, default='log/default.csv', help='path to save log')
