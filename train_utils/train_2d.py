...
from .losses import LpLoss, darcy_loss, PINO_loss, SPDC_loss
...
def train_SPDC(model,
    ...
    for e in pbar:
        ...
        for x, y in train_loader:
            ...
            data_loss,ic_loss,pde_loss = SPDC_loss(out,x,y)
            total_loss = ic_loss * ic_weight + pde_loss * f_weight + data_loss * data_weight
